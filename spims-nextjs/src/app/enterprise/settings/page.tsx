      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-2xl shadow-sm border border-neutral-200/80 p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-xl font-bold text-[#0a0a0a]">Enterprise Settings</h1>
              <p className="text-sm text-neutral-600">Manage your enterprise preferences</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200">
              ...
              <p className="text-sm text-neutral-600">
                Your enterprise account settings. Contact your system administrator for organization or department changes.
              </p>
            </div>
            ...
            <div className="p-4 bg-neutral-50 rounded-xl border border-neutral-200">
              ...
              <p className="text-sm text-neutral-600">
                Receive notifications for new complaint assignments, status updates, and worker assignments. Configure your preferences below.
              </p>
            </div>
          </div>
        </div>
